...
def main():
    ...
    if 'gpt2' in model_args.model_name_or_path:
    ...
    elif 'gptANY' in model_args.model_name_or_path:
        config = GPT2Config(vocab_size = 50257,n_positions = 1024,n_embd = 768,n_layer = 6,n_head = 12)
        config.return_dict = True
        config.tie_word_embeddings = False
        ...
        # Model.
        gpt_model = GPT2LMHeadModel(config=config)
    #print(gpt_model)
    ...
    else: # must have trainer.args.gradient_accumulation_steps
